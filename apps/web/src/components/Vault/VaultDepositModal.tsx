...
/**
 * Modal principale pour le dépôt dans un vault
 * Phase 1 : Structure de base avec Timeline
 */
        ...
        <div className="VaultDepositModal__Header">
          <span className="VaultDepositModal__Title">
            {currentStep === VaultModalStep.SUCCESS
              ...
              : 'Deposit Liquidity to Sticky Vault'
            }
          </span>
          <button
            className="VaultDepositModal__Close"
            onClick={() => {
              console.log('VaultDepositModal: Header close button clicked');
              onClose();
            }}
            aria-label="Close"
          >
