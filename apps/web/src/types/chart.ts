...
// Vault data (generated by indexer)
export interface VaultDayData {
  id: string;
  date: number;
  vault: string;
  // cumulative values / snapshots
  totalValueLockedUSD: string;
  collectedFeesUSD: string;
  tradingVolumeUSD: string;
  depositWithdrawVolumeUSD: string;
  // optional extras present in day data
  volumeUSD1D?: string;
  volumeUSD30D?: string;
}

export interface VaultHourData {
  id: string;
  periodStartUnix: number;
  vault: string;
  // cumulative values / snapshots
